...
//     }.elsewhen((imem_module.io.dataOut(6,0) === 23.U ) && !again_ins)  // This block will run in the first execution (load)
//     {
//         again_ins := true.B
//     }
...
//     when(imem_module.io.dataOut(6,0) === 3.U && again_ins)
//     {
//         register_module.io.wen := 0.B
//     }
...
//     // false means we are executing the same instruction in the second cycle,  again_ins
